...
#' 
#' - 2.0 Accepted Droplet Count Check
#' - 3.0 NTC Control Check
#' - 5.0 Control Warning - Positives Droplets 
#' - 6.0 Extraction & Negative Control Check
#' - 7.0 Sample Positive Droplet Sum Check
#' - 8.0 Recovery Control Check
#' - 9.0 Target Positives Droplet High Limit
#' 
